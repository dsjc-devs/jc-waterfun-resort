...
const MarketingMaterialsTable = ({ queryObj = {} }) => {
    ...
    const handleDelete = async () => {
        try {
            if (deleteTarget) {
                await MarketingMaterials.deleteMarketingMaterial(deleteTarget._id);
    ...
    const handleFormSubmit = async (values, { resetForm }) => {
        try {
            ...
            if (modalState.editingMarketingMaterial) {
                await MarketingMaterials.editMarketingMaterial(
                    modalState.editingMarketingMaterial._id,
                    formData
                );
                toast.success("Marketing Material updated");
            } else {
                await MarketingMaterials.addMarketingMaterial(formData);
